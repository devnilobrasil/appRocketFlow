...
const KicksChart = ({ playerData }) => {
    // Estrutura os dados para o gráfico
    const chartData = Object.keys(playerData).map((player, index) => ({
        name: player,
        chutes: playerData[player].chutes, // Acessa a soma dos chutes do jogador na temporada
    }));
    ...
    return (
        <div className="flex flex-col w-full items-center justify-center gap-8">
            <h1 className="text-3xl text-white font-bold">CHUTES</h1>
            <ResponsiveContainer width="100%" height={400}>
                <BarChart data={chartData}>
                    ...
                    <Bar dataKey="chutes" fill="#ffc300">
                        <LabelList dataKey="chutes" position="top" content={<CustomizedLabel />} />
                    </Bar>
                </BarChart>
            </ResponsiveContainer>
        </div>
